$(document).ready(function() {
	...
	$(".mws-datepicker").datepicker({dateFormat: 'yy-mm-dd',showOtherMonths:true});
	
	$(".mws-datepicker-wk").datepicker({dateFormat: 'yy-mm-dd',showOtherMonths:true, showWeek:true});
	
	$(".mws-datepicker-mm").datepicker({dateFormat: 'yy-mm-dd',showOtherMonths:true, numberOfMonths:3});
	
	$(".mws-datepicker-yr").datepicker({dateFormat: 'yy-mm-dd', changeMonth: true, changeYear: true, yearRange: "1987:2014"});
	
	$(".mws-datepicker-btn").datepicker({dateFormat: 'yy-mm-dd',showOtherMonths:true, showButtonPanel: true});
