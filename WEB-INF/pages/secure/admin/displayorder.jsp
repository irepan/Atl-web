...
<script>
	...
	function loadCommunicationsData(){
		$(document).ready(function() {
		    $.ajax({
		    	...
		    	type:"GET",  
		    	// url 
		        url: '/atlas-web/displayOrder/communication/list',
		        // type data on load
		        dataType: "json",
		        cache: false,
		        timeout: 5000,
	...
	function updateComms(){
		$.ajax({
           url: '/atlas-web/displayOrder/communication/update',
           type: 'POST',
           dataType: 'json',
	...
	function loadPersonnelData(){
		$(document).ready(function() {
		    $.ajax({
		    	type:"GET",  
		        url: '/atlas-web/displayOrder/personnel/list',
		        dataType: "json",
		        cache: false,
		        timeout: 500,
		        success: function(data) {
	...
	function updatePersonnel(){
		$.ajax({
	           url: '/atlas-web/displayOrder/personnel/update',
	           type: 'POST',
	           dataType: 'json',
	...
	function loadAircraftData(){
		$(document).ready(function() {
		    $.ajax({
		    	type:"GET",  
		        url: '/atlas-web/displayOrder/aircraft/list',
		        dataType: "json",
		        cache: false,
		        timeout: 5000,
		        success: function(data) {
	...
	function updateAircrafts(){
		$.ajax({
	           url: '/atlas-web/displayOrder/aircraft/update',
	           type: 'POST',
	           dataType: 'json',
